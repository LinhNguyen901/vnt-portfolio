    ...
    <Card className={`grid-item ${className}`}>
      <CardBody>
        ...
        <div className={`title-wrapper`}>
          ...
          <span className={`font-family-subheadings fw-bold text-muted text-1 ms-1`}>
            {subtitle}
          </span>
        </div>
        ...
        {text && (
          <div className={`main-content-wrapper mt-2 mb-3`}>
            <div className={`text opacity-75`} dangerouslySetInnerHTML={{ __html: text }} />
          </div>
        )}
      </CardBody>
    </Card>
